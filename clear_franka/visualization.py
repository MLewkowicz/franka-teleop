...
from clear_franka.franka import (
    ...
    DEFAULT_GRIPPER_JOINT_CLOSED,
    DEFAULT_GRIPPER_JOINT_NAME,
    ROBOT_DESCRIPTIONS_CACHE_ROOT,
    ROBOT_XACRO_ARGS,
    _get_manual_description,
    bake_cortado_urdf as _bake_cortado_urdf,
    get_cortado_description as _get_cortado_description,
    _CORTADO_DESCRIPTION_REPO_URL,
    _CORTADO_DESCRIPTION_COMMIT,
)
